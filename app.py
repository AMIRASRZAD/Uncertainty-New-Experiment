...
def step2():
    ...
    # Simulate AI prediction (25,000 data points)
    predicted_default_25k = task_data['Confidence_Score'] * 100  # Scale to 0-100%
...
def step3():
    ...
    predicted_default_25k = task_data['Confidence_Score'] * 100
    decision_25k = "Reject" if predicted_default_25k > 50 else "Accept"
...
def step4():
    ...
    if request.method == 'POST':
        ...
        # Calculate reward
        actual_default = task_data['Creditability'] * 100  # 0 or 1 scaled to 0 or 100
        ...
        session['responses'].append({
            ...
            'predicted_default_25k': task_data['Confidence_Score'] * 100,
            'predicted_default_50k': task_data['Confidence_Score'] * 100 * 0.9,  # Simulate slight improvement
            'confidence_25k': task_data['Confidence_Score'],
            'confidence_50k': task_data['Confidence_Score'] * 0.9,
            'reward': reward
        })
    ...
    predicted_default_50k = task_data['Confidence_Score'] * 100 * 0.9  # Slightly improved
